...
DEFINE_GUID(WINDIVERT_SUBLAYER_INBOUND_IPV4_GUID,
    0xC460E6B9, 0x49FA, 0x48C7,
    0xB4, 0xCB, 0xF4, 0x1B, 0x8D, 0xAD, 0xE9, 0x64);
DEFINE_GUID(WINDIVERT_SUBLAYER_OUTBOUND_IPV4_GUID,
    0x2CE59D1C, 0xA4E0, 0x4383,
    0x83, 0x3A, 0x05, 0x96, 0x09, 0x56, 0x0A, 0xD3);
DEFINE_GUID(WINDIVERT_SUBLAYER_INBOUND_IPV6_GUID,
    0xACEBB640, 0x2FD0, 0x43E7,
    0x8B, 0x9A, 0x0D, 0x08, 0xD8, 0xBD, 0xFA, 0x33);
DEFINE_GUID(WINDIVERT_SUBLAYER_OUTBOUND_IPV6_GUID,
    0x8FC8D67B, 0xDC31, 0x436B,
    0xAA, 0xC1, 0x69, 0xA1, 0xE3, 0x0B, 0xAE, 0x9D);
DEFINE_GUID(WINDIVERT_SUBLAYER_FORWARD_IPV4_GUID,
    0x3C1363CD, 0x284C, 0x41C5,
    0x9A, 0xD8, 0xE3, 0x82, 0x61, 0x29, 0x12, 0x5D);
DEFINE_GUID(WINDIVERT_SUBLAYER_FORWARD_IPV6_GUID,
    0xF716EBE7, 0x5AB2, 0x42A5,
    0xAA, 0x1F, 0x82, 0x7D, 0xEB, 0x03, 0x71, 0x65);
